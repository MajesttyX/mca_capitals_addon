...
import fabric.net.conczin.mca.advancement.criterion.CriterionMCA;
import fabric.net.conczin.mca.entity.ai.BreedableRelationship;
import fabric.net.conczin.mca.entity.ai.relationship.EntityRelationship;
import fabric.net.conczin.mca.entity.ai.relationship.RelationshipState;
...
@Pseudo
@Mixin(targets = "fabric.net.conczin.mca.entity.ai.BreedableRelationship", remap = false)
