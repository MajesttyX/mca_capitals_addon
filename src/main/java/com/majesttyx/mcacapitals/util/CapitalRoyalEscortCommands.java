...
public final class CapitalRoyalEscortCommands {
    ...
    private static int review(CommandSourceStack source, String rawAmbassadorId) {
        ServerPlayer player;
        try {
        ...
        try {
            ...
            source.sendFailure(Component.literal("The Ambassador ID is invalid."));
            return 0;
        }
        return CapitalRoyalBetrothalService.openEscortRequests(player, ambassadorId);
    }
}
