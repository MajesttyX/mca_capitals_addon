...
public final class CapitalDiplomaticResolutionService {
    ...
    public static int acceptPlayerShipment(
        ...
        Validation validation = validatePlayerResponse(
                player,
                shipmentId
        );
    ...
    public static int returnPlayerShipment(
        ...
        shipment.setStatus(
                DiplomaticShipmentStatus.RETURNED_IN_TRANSIT
        );
    ...
    public static List<DiplomaticShipment> getPendingForPlayer(
            ServerLevel level,
            UUID playerId
    ) {
    ...
    private static Validation validatePlayerResponse(
        ...
        if (shipment == null
                || !shipment.isAwaitingPlayerResponse()) {
            return Validation.failure(
    ...
    private static void recordAccepted(
        ...
        String sourceName = capitalName(
                level,
                sourceCapital
        );

        String targetName = capitalName(
                level,
                targetCapital
        );
    ...
    private static void notifySource(
        ...
        if (recipient == null) {
            recipient = shipment.getSenderSovereignId();
        }
