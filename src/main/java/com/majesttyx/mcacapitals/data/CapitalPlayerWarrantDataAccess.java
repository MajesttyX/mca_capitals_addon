...
public final class CapitalPlayerWarrantDataAccess {
    private static final SavedData.Factory<CapitalPlayerWarrantSavedData> FACTORY =
    ...
    public static boolean clearLeaveOrder(ServerLevel level, UUID playerId, UUID capitalId) {
        return level != null
