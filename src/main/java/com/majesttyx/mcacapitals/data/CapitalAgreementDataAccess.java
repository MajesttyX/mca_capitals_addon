...
public final class CapitalAgreementDataAccess {
    ...
    public static List<CapitalTradeAgreement> getTradeAgreementsForCapital(
            ServerLevel level,
            UUID capitalId
    ) {
    ...
    public static Map<CapitalRelationKey, CapitalTradeAgreement> getTradeAgreementsSnapshot(
            ServerLevel level
    ) {
        if (level == null) {
            return Map.of();
