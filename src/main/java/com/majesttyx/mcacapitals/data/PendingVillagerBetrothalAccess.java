...
public final class PendingVillagerBetrothalAccess {
    ...
    public static List<PendingVillagerBetrothalSavedData.PendingPair>
    getPairs(ServerLevel level) {
        return get(level).getPairs();
    }

    public static List<PendingVillagerBetrothalSavedData.RoyalEscortRecord>
    getRoyalEscorts(ServerLevel level) {
        return get(level).getRoyalEscorts();
    }

    public static boolean hasPendingBetrothal(
            ServerLevel level,
            UUID villagerId
    ) {
    ...
    getRoyalEscort(
        ...
        return get(level).getRoyalEscort(
                firstId,
                secondId
        );
    }

    public static boolean containsPair(
            ServerLevel level,
            UUID firstId,
            UUID secondId
    ) {
        return get(level).containsPair(
                firstId,
                secondId
        );
    }

    public static void setPendingBetrothal(
            ServerLevel level,
            UUID firstId,
            UUID secondId
    ) {
    ...
    public static boolean completeRoyalEscort(
            ServerLevel level,
            UUID firstId,
            UUID secondId
    ) {
        return get(level).completeRoyalEscort(
                firstId,
                secondId,
                level.getGameTime()
        );
    ...
    public static void removePendingBetrothal(
            ServerLevel level,
            UUID firstId,
            UUID secondId
    ) {
        get(level).removePair(
                firstId,
                secondId
        );
    }
