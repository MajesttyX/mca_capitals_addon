...
public class ModItems {
    ...
    public static final DeferredItem<RoyalDisinheritanceItem> ROYAL_DISINHERITANCE =
            ITEMS.register("royal_disinheritance", RoyalDisinheritanceItem::new);

    public static final DeferredItem<LegitimizationDecreeItem> LEGITIMIZATION_DECREE =
            ITEMS.register("legitimization_decree", LegitimizationDecreeItem::new);

    public static final DeferredItem<DeclarationOfAbdicationItem> DECLARATION_OF_ABDICATION =
    ...
    public static final DeferredItem<RoyalSealItem> BLACK_ROYAL_SEAL =
            ITEMS.register("black_royal_seal", RoyalSealItem::new);

    public static final DeferredItem<RoyalSealItem> BLUE_ROYAL_SEAL =
            ITEMS.register("blue_royal_seal", RoyalSealItem::new);

    public static final DeferredItem<RoyalSealItem> GREEN_ROYAL_SEAL =
