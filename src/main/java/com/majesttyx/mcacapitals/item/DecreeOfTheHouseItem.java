...
public class DecreeOfTheHouseItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        tooltipComponents.add(Component.translatable("mcacapitals.system.decree_of_the_house_item.shift_right_click_a_villager_to_edit_their_surname_and_house_words_if").withStyle(ChatFormatting.GRAY));
    }
}